...
int main(int argc, char** argv){
  ...
  data_load = data_align(data_load, points_num, dim);//one must align the data before build
  IndexRandom init_index(dim, points_num);
  IndexGraph index(dim, points_num, efanna2e::L2, (efanna2e::Index*)(&init_index));
