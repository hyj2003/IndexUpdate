...
void run(const char* disk_in, const std::vector<std::string>& mem_in,
  ...
  diskann::IndexMerger<T> merger(disk_in, mem_in, disk_out, deleted_tags, ndims,
